...
<%--                        <input type="checkbox" name="price" class="custom-control-input" checked id="price-all" value="price-all">--%>
...
<%--                <form>--%>
<%--                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">--%>
<%--                        <input type="radio" name="star" class="custom-control-input" checked id="star-all" value="star-all">--%>
            ...
            <div class="row pb-3">
                <div class="col-12 pb-1">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="ml-2">
                            <div class="btn-group">
                                <button style="width: 130px" type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">Sorting</button>
                    ...
                    <div class="product-item bg-light mb-4">
                        ...
                        <div class="text-center py-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5><%=list.get(i).getPrice()*(1-list.get(i).getDiscount())%></h5><h6 class="text-muted ml-2"><del><%=list.get(i).getPrice()%></del></h6>
                            </div>
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                <%for (int j=1;j<=list.get(i).getStar();j++){%>
                                <small class="fa fa-star text-primary mr-1"></small>
                                <%}
                                    if ((list.get(i).getStar()*10)%10!=0){
                                %>
                                <small class="fa fa-star-half-alt text-primary mr-1"></small>
                                <%}%>
                                <small>(<%=list.get(i).getAmount()%>)</small>
                            </div>
                        </div>
                    </div>
                </div>
