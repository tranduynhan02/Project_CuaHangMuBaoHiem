  ...
  <div class="flex flex-col flex-1 w-full">
    ...
    <main class="h-full pb-16 overflow-y-auto">
      <div class="container grid px-6 mx-auto">
        ...
        <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200" style= "font-size: 1rem;margin-top: 50px"><a href="bill_manager.jsp">Lịch sử hóa đơn </a><span style="font-size: 1rem;color: rgb(183, 183, 183);">/ Chi tiết hóa đơn</span></h2>
        <!-- With actions -->
