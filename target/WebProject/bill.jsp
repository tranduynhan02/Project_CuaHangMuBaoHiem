    ...
    <main class="h-full pb-16 overflow-y-auto">
      <div class="container grid px-6 mx-auto">
        ...
        <div class="filter">
          ...
          <i class="fa fa-search" style="cursor: pointer; color: #d5d6d7;" ></i>
        </div>
        <!-- With actions -->
        <h4
            ...
            <table class="w-full whitespace-no-wrap">
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                  <p class="font-semibold">Trần Đặng Quốc</p>
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                  <p class="font-semibold">Nguyễn Minh Đức</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">
                    KH932
                  </p>
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                  <p class="font-semibold">Trần Duy Nhân</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">
                    KH827
                  </p>
                </td>
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                  <p class="font-semibold">Nguyễn Hoàng Tấn</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">
                    KH982
                  </p>
                </td>
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                  <p class="font-semibold">Trần Thanh Xuân</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">
                    KH129
                  </p>
                </td>
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                  <p class="font-semibold">Đỗ Đức Tài</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">
                    KH546
                  </p>
                </td>
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                  <p class="font-semibold">Trần Lê Quốc Thái</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">
                    KH003
                  </p>
                </td>
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                  <p class="font-semibold">Tạ Thanh Nhả</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">
                    KH222
                  </p>
                </td>
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                  <p class="font-semibold">Lê Trí Mạnh</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">
                    KH145
                  </p>
                </td>
        ...
        <div class="qlds" style="margin-top: 20px;">
          <span style="color: white;">Số lượng sản phẩm bán ra:</span>
          <input type="text" placeholder="Doanh số bán hàng" value="45" style="border-radius: 5px;">
          <span style="color: white;">Doanh số đạt được:</span>
          <input type="text" value="120,000,000 VNĐ" style="border-radius: 5px;">
        </div>
